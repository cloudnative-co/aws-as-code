...
SETUP_SSM_USER_DOCUMENT_NAME=`aws cloudformation describe-stack-resource --stack-name PfManagementStack --logical-resource-id setupssmuser --query 'StackResourceDetail.PhysicalResourceId'|tr -d '"'`
